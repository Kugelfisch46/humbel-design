...
const Hero: React.FC = () => {
    return (
        <div className="flex flex-col justify-center h-full">
            ...
            >
                <h1 className="text-5xl md:text-7xl font-bold text-dark mb-2 tracking-tighter">
                    humbel
                </h1>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex gap-4 mt-6">
                        <img src="/images/e1.jpg" alt="Showcase 1" className="w-1/2 rounded-lg shadow-sm object-cover h-32 hover:scale-105 transition-transform duration-500" />
                        <img src="/images/e2-scaled.jpg" alt="Showcase 2" className="w-1/2 rounded-lg shadow-sm object-cover h-32 hover:scale-105 transition-transform duration-500" />
                    </div>
                </div>
            </motion.div>
        </div>
